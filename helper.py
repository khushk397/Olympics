...
def most_successful(df, sport):
    ...
    result = top_15.merge(df, on='Name', how='left')[['Name', 'Medals', 'Sport', 'region']].drop_duplicates('Name')
...
def most_successful_athlete(df, country):
    ...
    result = top_15.merge(df, on='Name', how='left')[['Name', 'Medals', 'Sport']].drop_duplicates('Name')
